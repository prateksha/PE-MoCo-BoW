...
def parse_option():
    ...
    # dataset
    parser.add_argument('--dataset', type=str, default='imagenet100', choices=['imagenet100', 'imagenet200', 'imagenet'])
    ...
    opt.save_path = '/content/drive/My Drive/Imagenet/CMC/{}_linear'.format(opt.dataset)
    opt.tb_path = '/content/drive/My Drive/Imagenet/CMC/{}_linear_tensorboard'.format(opt.dataset)
