...
from models.resnet_experiment import InsResNet50
...
def parse_option():
    ...
    # dataset
    parser.add_argument('--dataset', type=str, default='imagenet100', choices=['imagenet100', 'imagenet', 'imagenet200'])
    ...
    opt.data_folder = '/content/drive/My Drive/Imagenet/{}'.format(opt.dataset)
    opt.model_path = '/content/drive/My Drive/Imagenet/CMC/{}_models'.format(opt.dataset)
    opt.tb_path = '/content/drive/My Drive/Imagenet/CMC/{}_tensorboard'.format(opt.dataset)
...
def train_moco(epoch, train_loader, model, model_ema, contrast, criterion, optimizer, opt):
    """
    one epoch training for moco discrimination
    """
